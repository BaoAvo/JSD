...
public class LibraryTransaction {
    ...
    public LibraryTransaction(Patron patronLib, Book bookLib, Date checkoutDate, Date dueDate, Date returnDate) {
        this.patronLib = patronLib;
        this.bookLib = bookLib;
        this.checkoutDate = checkoutDate;
        this.dueDate = dueDate;
        this.returnDate = returnDate;
        this.setFineAmount(calculateFine(returnDate,dueDate));
    }
